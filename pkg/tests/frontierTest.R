...
printME( efficiencies( a1, farrell = FALSE ) )
printME( efficiencies( a1, asInData = TRUE, farrell = FALSE ) )
...
print( summary( aa1, farrell = FALSE ), digits = 1 )
lrtest( aa1 )
printME( aa1eff <- efficiencies( aa1, margEff = TRUE ) )
printME( aa1effD <- efficiencies( aa1, asInData = TRUE, margEff = TRUE ) )
printME( aa1effF <- efficiencies( aa1, farrell = FALSE, margEff = TRUE ) )
printME( aa1effDF <- efficiencies( aa1, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
aa1m <- aa1
...
print( summary( bb2, farrell = FALSE ), digits = 1 )
lrtest( bb2 )
round( efficiencies( bb2 ), 2 )
round( efficiencies( bb2, asInData = TRUE ), 2 )
round( efficiencies( bb2, farrell = FALSE ), 2 )
round( efficiencies( bb2, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( bb6, farrell = FALSE ), digits = 1 )
lrtest( bb6 )
printME( bb6eff <- efficiencies( bb6, margEff = TRUE ) )
printME( bb6effD <- efficiencies( bb6, asInData = TRUE, margEff = TRUE ) )
printME( bb6effF <- efficiencies( bb6, farrell = FALSE, margEff = TRUE ) )
printME( bb6effDF <- efficiencies( bb6, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
bb6m1 <- bb6
...
print( summary( dd1, farrell = FALSE ), digits = 1 )
lrtest( dd1 )
round( efficiencies( dd1 ), 2 )
round( efficiencies( dd1, asInData = TRUE ), 2 )
round( efficiencies( dd1, farrell = FALSE ), 2 )
round( efficiencies( dd1, asInData = TRUE, farrell = FALSE ), 2 )
...
round( vcov( dd2 ), 4 )
nobs( dd2 )
print( summary( dd2, farrell = FALSE ), digits = 1 )
lrtest( dd2 )
round( efficiencies( dd2, farrell = FALSE ), 2 )
round( efficiencies( dd2, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( dd5, farrell = FALSE ), digits = 1 )
lrtest( dd5 )
printME( dd5eff <- efficiencies( dd5, margEff = TRUE ) )
printME( dd5effD <- efficiencies( dd5, asInData = TRUE, margEff = TRUE ) )
printME( dd5effF <- efficiencies( dd5, farrell = FALSE, margEff = TRUE ) )
printME( dd5effDF <- efficiencies( dd5, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
dd5m1 <- dd5
...
round( vcov( dd6 ), 4 )
nobs( dd6 )
print( summary( dd6, farrell = FALSE ), digits = 1 )
lrtest( dd6 )
round( efficiencies( dd6, farrell = FALSE ), 2 )
round( efficiencies( dd6, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( dd9, farrell = FALSE ), digits = 1 )
nobs( dd9 )
lrtest( dd9 )
...
round( efficiencies( b1, farrell = FALSE ), 2 )
round( efficiencies( b1, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( b5, farrell = FALSE ), digits = 1 )
lrtest( b5 )
printME( b5eff <- efficiencies( b5, margEff = TRUE ) )
printME( b5effD <- efficiencies( b5, asInData = TRUE , margEff = TRUE) )
printME( b5effF <- efficiencies( b5, farrell = FALSE, margEff = TRUE ) )
printME( b5effDF <- efficiencies( b5, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
b5m1 <- b5
...
print( summary( d1, farrell = FALSE ), digits = 1 )
lrtest( d1 )
round( efficiencies( d1 ), 2 )
round( efficiencies( d1, asInData = TRUE ), 2 )
round( efficiencies( d1, farrell = FALSE ), 2 )
round( efficiencies( d1, asInData = TRUE, farrell = FALSE ), 2 )
...
round( vcov( d2 ), 4 )
nobs( d2 )
print( summary( d2, farrell = FALSE ), digits = 1 )
lrtest( d2 )
round( efficiencies( d2, farrell = FALSE ), 2 )
round( efficiencies( d2, asInData = TRUE, farrell = FALSE ), 2 )
...
round( vcov( d3 ), 4 )
nobs( d3 )
print( summary( d3, farrell = FALSE ), digits = 1 )
lrtest( d3 )
round( efficiencies( d3, farrell = FALSE ), 2 )
round( efficiencies( d3, asInData = TRUE, farrell = FALSE ), 2 )
...
round( vcov( d4 ), 4 )
nobs( d4 )
print( summary( d4, farrell = FALSE ), digits = 1 )
lrtest( d4 )
round( efficiencies( d4, farrell = FALSE ), 2 )
round( efficiencies( d4, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( d5, farrell = FALSE ), digits = 1 )
lrtest( d5 )
printME( d5eff <- efficiencies( d5, margEff = TRUE ) )
printME( d5effD <- efficiencies( d5, asInData = TRUE, margEff = TRUE ) )
printME( d5effF <- efficiencies( d5, farrell = FALSE, margEff = TRUE ) )
printME( d5effDF <- efficiencies( d5, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
d5m1 <- d5
...
round( vcov( d6 ), 4 )
nobs( d6 )
print( summary( d6, farrell = FALSE ), digits = 1 )
lrtest( d6 )
round( efficiencies( d6, farrell = FALSE ), 2 )
round( efficiencies( d6, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( d9, farrell = FALSE ), digits = 1 )
nobs( d9 )
lrtest( d9 )
...
print( summary( b4u, farrell = FALSE ), digits = 1 )
nobs( b4u )
lrtest( b4u )
round( efficiencies( b4u ), 2 )
round( efficiencies( b4u, asInData = TRUE ), 2 )
round( efficiencies( b4u, farrell = FALSE ), 2 )
round( efficiencies( b4u, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( b6u, farrell = FALSE ), digits = 1 )
nobs( b6u )
lrtest( b6u )
printME( b6ueff <- efficiencies( b6u, margEff = TRUE ) )
printME( b6ueffD <- efficiencies( b6u, asInData = TRUE, margEff = TRUE ) )
printME( b6ueffF <- efficiencies( b6u, farrell = FALSE, margEff = TRUE ) )
printME( b6ueffDF <- efficiencies( b6u, asInData = TRUE, farrell = FALSE, 
   margEff = TRUE ) )
b6um1 <- b6u
...
print( summary( d1u, farrell = FALSE ), digits = 1 )
nobs( d1u )
lrtest( d1u )
round( efficiencies( d1u ), 2 )
round( efficiencies( d1u, asInData = TRUE ), 2 )
round( efficiencies( d1u, farrell = FALSE ), 2 )
round( efficiencies( d1u, asInData = TRUE, farrell = FALSE ), 2 )
...
d2u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, truncNorm = TRUE )
print( d2u )
print( summary( d2u, farrell = FALSE ), digits = 1 )
nobs( d2u )
lrtest( d2u )
round( efficiencies( d2u, farrell = FALSE ), 2 )
round( efficiencies( d2u, asInData = TRUE, farrell = FALSE ), 2 )
...
d3u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, timeEffect = TRUE )
print( d3u )
print( summary( d3u, farrell = FALSE ), digits = 1 )
nobs( d3u )
lrtest( d3u )
round( efficiencies( d3u, farrell = FALSE ), 2 )
round( efficiencies( d3u, asInData = TRUE, farrell = FALSE ), 2 )
...
d4u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, truncNorm = TRUE, timeEffect = TRUE )
print( d4u )
print( summary( d4u, farrell = FALSE ), digits = 1 )
nobs( d4u )
lrtest( d4u )
round( efficiencies( d4u, farrell = FALSE ), 2 )
round( efficiencies( d4u, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( d5u, farrell = FALSE ), digits = 1 )
nobs( d5u )
lrtest( d5u )
round( efficiencies( d5u ), 2 )
round( efficiencies( d5u, asInData = TRUE ), 2 )
round( efficiencies( d5u, farrell = FALSE ), 2 )
round( efficiencies( d5u, asInData = TRUE, farrell = FALSE ), 2 )
...
d6u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP | EDYRS + BANRAT,
   data = riceProdPhilPanelUnb, ineffDecrease = FALSE )
print( d6u )
print( summary( d6u, farrell = FALSE ), digits = 1 )
nobs( d6u )
lrtest( d6u )
round( efficiencies( d6u, farrell = FALSE ), 2 )
round( efficiencies( d6u, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( translog, farrell = FALSE ), digits = 1 )
lrtest( translog )
round( efficiencies( translog ), 2 )
round( efficiencies( translog, asInData = TRUE ), 2 )
round( efficiencies( translog, farrell = FALSE ), 2 )
round( efficiencies( translog, asInData = TRUE, farrell = FALSE ), 2 )
...
print( summary( translogZvar, farrell = FALSE ), digits = 1 )
lrtest( translogZvar )
printME( efficiencies( translogZvar, margEff = TRUE ) )
printME( efficiencies( translogZvar, asInData = TRUE, margEff = TRUE ) )
printME( efficiencies( translogZvar, farrell = FALSE, margEff = TRUE ) )
printME( efficiencies( translogZvar, asInData = TRUE, farrell = FALSE, margEff = TRUE ) )
...
print( summary( Sa1, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( a1, logDepVar = FALSE ), 2 )
round( efficiencies( a1, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( a1, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( a1, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )
...
print( summary( Saa1, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
printME( efficiencies( aa1, logDepVar = FALSE, margEff = TRUE ) )
printME( efficiencies( aa1, asInData = TRUE, logDepVar = FALSE ) )
printME( efficiencies( aa1, logDepVar = FALSE, farrell = FALSE ) )
printME( efficiencies( aa1, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ) )
...
## cross-section rice data, error components cost frontier
print( summary( Sdd1, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( dd1, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( dd1, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## cross-section rice data, error components cost frontier, truncNorm
print( summary( dd2, logDepVar = FALSE ), digits = 1 )
print( summary( dd2, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( dd2, logDepVar = FALSE ), 2 )
round( efficiencies( dd2, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( dd2, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( dd2, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## cross-section rice data, efficiency effects cost frontier
print( summary( Sdd5, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( dd5, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( dd5, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## cross-section rice data, efficiency effects cost frontier, zIntercept
print( summary( dd6, logDepVar = FALSE ), digits = 1 )
print( summary( dd6, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( dd6, logDepVar = FALSE ), 2 )
round( efficiencies( dd6, asInData = TRUE , logDepVar = FALSE ), 2 )
round( efficiencies( dd6, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( dd6, asInData = TRUE , logDepVar = FALSE, farrell = FALSE ), 2 )
...
print( summary( b4, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( b4, logDepVar = FALSE ), 2 )
round( efficiencies( b4, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( b4, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( b4, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )
...
print( summary( b6, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( b6, logDepVar = FALSE ), 2 )
round( efficiencies( b6, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( b6, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( b6, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, error components cost frontier
print( summary( Sd1, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d1, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d1, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, error components cost frontier, truncNorm
print( summary( d2, logDepVar = FALSE ), digits = 1 )
print( summary( d2, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d2, logDepVar = FALSE ), 2 )
round( efficiencies( d2, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( d2, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d2, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, error components cost frontier, timeEffect
print( summary( d3, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d3, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d3, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, error components cost frontier, truncNorm, timeEffect
print( summary( d4, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d4, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d4, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, efficiency effects cost frontier
print( summary( Sd5, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d5, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d5, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## panel rice data, efficiency effects cost frontier, zIntercept
print( summary( d6, logDepVar = FALSE ), digits = 1 )
print( summary( d6, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d6, logDepVar = FALSE ), 2 )
round( efficiencies( d6, asInData = TRUE, logDepVar = FALSE ), 2 )
round( efficiencies( d6, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d6, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )
...
## unbalanced panel rice data, error components cost frontier
print( summary( d1u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d1u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d1u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## unbalanced panel rice data, error components cost frontier, truncNorm
print( summary( d2u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d2u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d2u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## unbalanced panel rice data, error components cost frontier, timeEffect
print( summary( d3u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d3u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d3u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## unbalanced panel rice data, error components cost frontier, truncNorm, timeEffect
print( summary( d4u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d4u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d4u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## unbalanced panel rice data, efficiency effects cost frontier
print( summary( d5u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d5u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d5u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )

## unbalanced panel rice data, efficiency effects cost frontier, zIntercept
print( summary( d6u, logDepVar = FALSE, farrell = FALSE ), digits = 1 )
round( efficiencies( d6u, logDepVar = FALSE, farrell = FALSE ), 2 )
round( efficiencies( d6u, asInData = TRUE, logDepVar = FALSE, farrell = FALSE ), 2 )
