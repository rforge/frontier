...
print( summary( aa1, minusU = FALSE ), digits = 1 )
lrtest( aa1 )
...
print( summary( bb2, minusU = FALSE ), digits = 1 )
lrtest( bb2 )
...
print( summary( bb6, minusU = FALSE ), digits = 1 )
lrtest( bb6 )
...
print( summary( dd1, minusU = FALSE ), digits = 1 )
lrtest( dd1 )
...
round( vcov( dd2 ), 4 )
nobs( dd2 )
print( summary( dd2, minusU = FALSE ), digits = 1 )
lrtest( dd2 )
...
print( summary( dd5, minusU = FALSE ), digits = 1 )
lrtest( dd5 )
...
round( vcov( dd6 ), 4 )
nobs( dd6 )
print( summary( dd6, minusU = FALSE ), digits = 1 )
lrtest( dd6 )
...
print( summary( dd9, minusU = FALSE ), digits = 1 )
nobs( dd9 )
lrtest( dd9 )
...
print( summary( b5, minusU = FALSE ), digits = 1 )
lrtest( b5 )
...
print( summary( d1, minusU = FALSE ), digits = 1 )
lrtest( d1 )
...
round( vcov( d2 ), 4 )
nobs( d2 )
print( summary( d2, minusU = FALSE ), digits = 1 )
lrtest( d2 )
...
round( vcov( d3 ), 4 )
nobs( d3 )
print( summary( d3, minusU = FALSE ), digits = 1 )
lrtest( d3 )
...
round( vcov( d4 ), 4 )
nobs( d4 )
print( summary( d4, minusU = FALSE ), digits = 1 )
lrtest( d4 )
...
print( summary( d5, minusU = FALSE ), digits = 1 )
lrtest( d5 )
...
round( vcov( d6 ), 4 )
nobs( d6 )
print( summary( d6, minusU = FALSE ), digits = 1 )
lrtest( d6 )
...
print( summary( d9, minusU = FALSE ), digits = 1 )
nobs( d9 )
lrtest( d9 )
...
print( summary( b4u, minusU = FALSE ), digits = 1 )
nobs( b4u )
lrtest( b4u )
...
print( summary( b6u, minusU = FALSE ), digits = 1 )
nobs( b6u )
lrtest( b6u )
...
print( summary( d1u, minusU = FALSE ), digits = 1 )
nobs( d1u )
lrtest( d1u )
...
d2u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, truncNorm = TRUE )
print( d2u )
print( summary( d2u, minusU = FALSE ), digits = 1 )
nobs( d2u )
lrtest( d2u )
...
d3u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, timeEffect = TRUE )
print( d3u )
print( summary( d3u, minusU = FALSE ), digits = 1 )
nobs( d3u )
lrtest( d3u )
...
d4u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP, data = riceProdPhilPanelUnb,
   ineffDecrease = FALSE, truncNorm = TRUE, timeEffect = TRUE )
print( d4u )
print( summary( d4u, minusU = FALSE ), digits = 1 )
nobs( d4u )
lrtest( d4u )
...
print( summary( d5u, minusU = FALSE ), digits = 1 )
nobs( d5u )
lrtest( d5u )
...
d6u <- sfa( lCost ~ lPROD + lAREA + lLABORP + lNPKP | EDYRS + BANRAT,
   data = riceProdPhilPanelUnb, ineffDecrease = FALSE )
print( d6u )
print( summary( d6u, minusU = FALSE ), digits = 1 )
nobs( d6u )
lrtest( d6u )
...
print( summary( translog, minusU = FALSE ), digits = 1 )
lrtest( translog )
...
print( summary( translogZvar, minusU = FALSE ), digits = 1 )
lrtest( translogZvar )
...
print( summary( Sa1, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( Saa1, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
## cross-section rice data, error components cost frontier
print( summary( Sdd1, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( dd2, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
## cross-section rice data, efficiency effects cost frontier
print( summary( Sdd5, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( dd6, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( b4, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( b6, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
## panel rice data, error components cost frontier
print( summary( Sd1, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( d2, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
...
print( summary( d6, logDepVar = FALSE, minusU = FALSE ), digits = 1 )
