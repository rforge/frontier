	...
	program exec   
c       FRONTIER version 4.1b by Tim Coelli.   
...
c       efficiency.   
	...
	if (ncall.eq.1) then
	write (70,401) 
  401   format(/,'Output from the program FRONTIER (Version 4.1n)',//)  
