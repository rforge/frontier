...
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
   startVal = coef( a1 ), maxit = 0 )$startLogl
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
...
logLik( a2 )
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
   truncNorm = TRUE, startVal = coef( a2 ), maxit = 0 )$startLogl
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
...
logLik( a5 )
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
   truncNorm = TRUE, startVal = coef( a5 ), maxit = 0 )$startLogl
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
...
logLik( aa1 )
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
   zNames = "firmNo", startVal = coef( aa1 ), maxit = 0 )$startLogl
frontier( data = front41Data, "logOutput", c( "logCapital", "logLabour" ),
...
frontier( data = riceProdPhil, yName = "lPROD",
   ...
   startVal = coef( bb2 ), maxit = 0 )$startLogl
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
   startVal = coef( bb2 ), code = "R", evalLogLik = TRUE )$startLogl

## cross-section rice data, efficiency effects frontier
logLik( bb5 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   startVal = coef( bb5 ), maxit = 0 )$startLogl
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
...
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   zIntercept = TRUE, startVal = coef( bb6 ), maxit = 0 )$startLogl
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
...
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
   startVal = coef( bb7 ), maxit = 0 )$startLogl
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
...
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   zIntercept = TRUE, startVal = coef( bb8 ), maxit = 0 )$startLogl
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
...
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
   startVal = coef( b2 ), maxit = 0 )$startLogl

## panel data, error components frontier, timeEffect
logLik( b3 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), timeEffect = TRUE,
   startVal = coef( b3 ), maxit = 0 )$startLogl

## panel data, error components frontier, truncNorm, timeEffect
logLik( b4 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
   timeEffect = TRUE, startVal = coef( b4 ), maxit = 0 )$startLogl

## panel data, efficiency effects frontier
logLik( b5 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   startVal = coef( b5 ), maxit = 0 )$startLogl

## panel data, efficiency effects frontier, zIntercept
logLik( b6 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   zIntercept = TRUE, startVal = coef( b6 ), maxit = 0 )$startLogl

## panel data, error components frontier, truncNorm, timeEffect, starting values
logLik( b7 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), truncNorm = TRUE,
   timeEffect = TRUE, startVal = coef( b7 ), maxit = 0 )$startLogl

## panel data, efficiency effects frontier, zIntercept, starting values
logLik( b8 )
frontier( data = riceProdPhil, yName = "lPROD",
   xNames = c( "lAREA", "lLABOR", "lNPK" ), zNames = c( "EDYRS", "BANRAT" ),
   zIntercept = TRUE, startVal = coef( b8 ), maxit = 0 )$startLogl
